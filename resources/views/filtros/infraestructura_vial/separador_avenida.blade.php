...
@section('title', 'Separador de avenidas')

@section('content')
    <ul class="breadcrumb">
        <li><a href="{{ url('buscar_plantas') }}">Inicio</a></li>
        <li><a href="{{ url('buscar_plantas/categorizacion') }}">Categorización</a></li>
        <li class="active">Infraestructura Vial <small>(Separador de avenidas)</small></li>
    </ul>
            ...
            <div class="row">
                @foreach($chunk as $ficha_tecnica)
                    <div class="col-md-4 col-sm-4">
                        <a href="{{ url('ficha_tecnica_user/'.$ficha_tecnica->id.'/ruta/1') }}" class="card card-result">
