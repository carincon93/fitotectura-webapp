            ...
            <div class="row">
                @foreach($chunk as $ficha_tecnica)
                    <div class="col-md-4 col-sm-4">
                        <a href="{{ url('ficha_tecnica_user/'.$ficha_tecnica->id.'/ruta/20') }}" class="card card-result">
